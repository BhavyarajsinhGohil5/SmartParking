...
<!--     <div class="row justify-content-center">
        <div class="col-md-8"> -->
            <div class="card shadow p-4">
                <h2 class="text-center mb-4">Fill Vehicle Details</h2>

                <form action="saveuservehicle" method="post">
                    <!-- Vehicle Registration Number -->
                    <div class="mb-3">
                        <label for="vehicleRegNo" class="form-label">Vehicle Registration Number</label>
                        <input type="text" name="vehicleRegNo" id="vehicleRegNo" maxlength="13"
                               class="form-control" placeholder="MH-12-AB-1234" required
                               oninput="formatVehicleReg(this)">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check p-l-20">
                            <input class="form-check-input" type="radio" name="vehicleType" value="4 Wheeler" id="type4w">
                            <label class="form-check-label" for="type4w">4 Wheeler</label>
                        </div>
                        <div class="form-check p-l-20">
                            <input class="form-check-input" type="radio" name="vehicleType" value="2 Wheeler" id="type2w">
                            <label class="form-check-label" for="type2w">2 Wheeler</label>
                        </div>
                        <div class="form-check p-l-20">
                            <input class="form-check-input" type="radio" name="vehicleType" value="SUV" id="typeSUV">
                            <label class="form-check-label" for="typeSUV">SUV</label>
                        </div>
                    </div>
                    ...
                    <div class="text-center d-flex justify-content-center gap-3 mt-4" style="display: inline-flex; gap: 10px;">
                        <input type="submit" value="Save Vehicle" class="btn btn-success px-4"/></br>
                         <a href="useraddreservation" class="btn btn-secondary px-4">Next</a>
                    </div>
                </form>
         <!--    </div>
        </div> -->
