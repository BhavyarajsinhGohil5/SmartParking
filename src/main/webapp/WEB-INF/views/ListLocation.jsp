...
<head>
  ...
  <title>Admin | List Location</title>
           ...
           <!-- End Customers Card -->
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Locations <span>/All</span></h5>
  <div class="table-responsive">
<table class="table datatable datatable-table table-hover center-align" id="myLocationTable">
  ...
  <jsp:include page="AdminJs.jsp"></jsp:include>
	...
	$( document ).ready(function() {
		let table = new DataTable('#myLocationTable',{
