...
<body class="animsition">
	...
	<form class="bg0 p-t-75 p-b-85">
		<div class="container">
			<div class="row">
				<div class="col-lg-100 col-xl-80 m-lr-auto m-b-50">
					<div class="m-l-15 m-r--34  m-lr-0-xl">
						<div class="wrap-table-shopping-cart-responsive">
...
<c:set var="amt" value="0"></c:set>
	<!-- Parking Booking -->
	<form class="bg0 p-t-75 p-b-85" action="bookParking" method="post">
		<div class="container">
			<div class="col">
				<div class="col-lg-100 col-xl-80 m-lr-auto m-b-50" >
					 <div class="m-l-15 m-r--34 m-lr-0-xl">
						<div class="wrap-table-shopping-cart-responsive" style="margin: auto;display: flex; justify-content: center; align-items: center;">
							<table class="table-shopping-cart" style="margin: auto; border-collapse: collapse;" >
								<tr class="table_head">
									<!-- <th class="column-1">Reservation Spot</th> -->
									<th class="column-1">Location</th>
									<th class="column-2">Parking Area</th>
									<th class="column-3">Parking Spot</th>
									<th class="column-4">Vehicle Registration No</th>
									<th class="column-5">Date</th>
									<th class="column-6">Start Time</th>
									<th class="column-7">End Time</th>
									<th class="column-5">Duration</th>
									<th class="column-8">Amuont</th>
									<th class="column-9">Total</th>
								...
								<%-- <c:forEach items="${parkingSpots}" var="spot">
										<td class="column-1">
											<div class="how-itemcart1">
												<img src="${spot[3]}" alt="IMG">
											</div>
										</td>
								</c:forEach> --%>
										<td class="column-1" >${spot[0]}Ahemdabad</td><!--Location Name -->
										<%-- <c:forEach items="${allReservation}" var="r"> --%>
										<td class="column-2" >${r[13]}Navrangpura</td><!--Parking Area (Address) Name -->
										<td class="column-3" >${r[12]}Municipal Corp.</td><!--Parking Spot(Title) Name -->
										<td class="column-4" >${r[17]}GJ-01-JR-9999</td><!--VehicleRegNo -->
										<td class="column-5">${r[2]}2025-04-01</td><!--Date  -->
										<td class="column-6">${r[7]}13:00:00</td><!--Start Time  -->
										<td class="column-7">${r[3]}14:00:00</td><!--End Time  -->
										<td class="column-8">${spot[4]}60 min</td><!--Duration  -->
										<td class="column-8">Rs.${r[1]}25.0</td><!--Amount  -->
										<td class="column-9">Rs.${r[1] + r[6]}25.0</td><!--Total  -->
										<td class="column-10">
											<a href="removeBooking?bookingId=${r[5]}"><i class="zmdi zmdi-delete"></i></a>
										</td><%-- </c:forEach> --%>
										<span style="display: none;">${amt = amt + spot[1] * spot[4]}</span>
									</tr>
							</table>
						</div>
					</div>
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						<h4 class="mtext-109 cl2 p-b-30">Booking Totals</h4>
						<div class="flex-w flex-t bor12 p-b-13">
							<div class="size-208">
								<span class="stext-110 cl2">Subtotal:70</span>
							</div>
							<div class="size-209">
								<span class="mtext-110 cl2">Rs.${amt}70 + 0 <small>Service Fees</small></span>
							</div>
						</div>
						<div class="flex-w flex-t p-t-27 p-b-33">
							<div class="size-208">
							...
							<div class="size-209 p-t-1">
								<span class="mtext-110 cl2">Rs.${amt}70</span>
							</div>
						</div>
						<a href="checkout" class="btn flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Proceed to Checkout</a>
					</div>
				</div>
			</div>
		</div><!--  Container-->
...
<form class="bg0 p-t-75 p-b-85" action="bookParking" method="post">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-100 col-xl-80">
                <!-- <div class="m-l-15 m-r--34 m-lr-0-xxl"> -->
                    <div class="table-responsive" >
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <tr class="table_row">
                                ...
                                <td class="column-2">${reservation.address}</td> <!-- Parking Area (Address) Name -->
                                <td class="column-3">${r[12]} Municipal Corp.</td> <!-- Parking Spot (Title) Name -->
                                <td class="column-4">${r[17]} GJ-01-JR-9999</td> <!-- VehicleRegNo -->
                                <td class="column-5">${r[2]} 2025-04-01</td> <!-- Date -->
                                <td class="column-6">${r[7]} 13:00:00</td> <!-- Start Time -->
...
<jsp:include page="ViewReservation.jsp"></jsp:include>
            <div class="col-lg-6 col-xl-5 mt-5">
                <div class="bor10 p-4 text-center">
                    <h4 class="mtext-109 cl2 p-b-20">Booking Totals</h4>
                    <div class="d-flex justify-content-between bor12 p-2">
                        <span class="stext-110 cl2">Subtotal:</span>
                        <span class="mtext-110 cl2">Rs.${amt} 70 + 0 <small>Service Fees</small></span>
                    </div>
