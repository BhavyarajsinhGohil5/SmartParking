...
<a href="#" class="flex-c-m trans-04 p-lr-25">
  ...
  <%--  <h2>Confirm Your Parking Payment</h2>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow-lg rounded-4 p-4">
                <h2 class="text-center mb-4">Confirm Your Parking Payment</h2>

                <div class="mb-3">
                    <label for="amount" class="form-label">Total Amount (₹)</label>
                    <input type="number" class="form-control" name="amount" id="amount" value="${amount}" disabled>
                </div>

                <form action="pay" method="post">
                    <div class="mb-3">
                        <label for="ccNum" class="form-label">Card Number</label>
                        <input type="text" class="form-control" name="ccNum" id="ccNum" required>
                    </div>

                    <div class="mb-3">
                        <label for="expDate" class="form-label">Expiry Date (MM/YY)</label>
                        <input type="text" class="form-control" name="expDate" id="expDate" required>
                    </div>
